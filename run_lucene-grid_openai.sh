...
create_job_file() {
    ...
    cat > $job_file << EOF
{
  "benchmarkID" : "ANN_OPENAI5M_LUCENE_HNSW_T${threads}_M${max_conn}_B${beam_width}",
  "datasetFile" : "/data/openai/OpenAI_4.6Mx1536.fvecs",
  "indexOfVector" : 1,
  ...
  "groundTruthFile" : "/data/openai/OpenAI_4.6Mx1536_groundtruth_k100_1000.csv",
